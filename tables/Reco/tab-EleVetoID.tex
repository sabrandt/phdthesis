...
$PFIso/p_T$ &$< 0.198+0.506/p_{T,ele}$ &$< 0.203+0.963/p_{T,ele}$ \\ \hline
Missing Hits & $\leq 2$ & $\leq 3$\\ \hline
\multicolumn{3}{|c|}{Pass conversion veto}\\
\hline
\end{tabular}}
\end{center}
\caption{Selection requirements for electrons passing the loose working point cut-based ID for 2017 data-taking.}
\label{tab:Reco:Ele:LooseID}
\end{table}