...
Process   	      &   \multicolumn{1}{c}{\Z} &&  \multicolumn{1}{c}{\Wp} &&  \multicolumn{1}{c}{\Wm}  	    \\
%\cline{2-2}\cline{4-4}
\hline
...
\end{tabular}
\caption{Best-fit yields from various processes in \Z, \Wp, and \Wm electron final states at \serag. Uncertainties shown are a combination of systematic and statistical.}
...
\end{tabular}
\caption{Best-fit yields from various processes in \Z, \Wp, and \Wm muon final states at \serag. Uncertainties shown are a combination of systematic and statistical.}
