...
\end{tabular}}
\end{center}
\caption{\pt bin boundaries used for each efficiency category. Trigger efficiency includes finer bins at lower \pt to capture any trigger turn-on effects. Other categories are relatively stable with respect to \pt.}
