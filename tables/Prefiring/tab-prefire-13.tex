...
\caption{Correction factors to account for prefiring in the \serah (2017H) dataset. The "Jets \& Photons" column includes proper counting of overlapping objects and is the scale factor used to renormalize the MC.}
