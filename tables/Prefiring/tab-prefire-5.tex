...
\caption{Correction factors to account for prefiring in the \serag (2017G) dataset. The "Jets \& Photons" column includes proper counting of overlapping objects and is the scale factor used to renormalize the MC.}
\label{tab:prefire:5}
\end{table}
